...
import car from "/public/images/ferrari-1.png";
...
const Winner = () => {
  ...
  return (
    <section className="position-relative pt-120 pb-120" id="winner">
      <div className="bg-el">
                  ...
                  {[1, 2, 3, 4, 5].map((itm, i) => (
                    <div key={itm} className="winner-slide-item">
                      ...
                      <div className="winner-content bg_img">
                        <h6 className="winner-name">10 Ferrari Car</h6>
                        <p></p>
                        <span className="draw-date">@100M MC</span>
                      </div>
                    </div>
                  ))}
                </Slider>
