...
import logo from "/public/images/ferrari.png";
            ...
            <div className="col-sm-6">
              <div className="right">
                <div className="product__cart">
                  ...
                  <Link href="" className="amount__btn">
        ...
        <div className="container">
          <nav className="navbar navbar-expand-xl p-0 align-items-center">
            <Link href="/" className="site-logo site-title">
              <Image className={`${styls.ferrlog}`} src={logo} alt="logo" />
            </Link>
            <button
            ...
            >
              <ul className="navbar-nav main-menu ms-auto">
                ...
                >
                  <Link href="#contest" onClick={(e) => handleOpen(e)}>
                    Contest
                  </Link>
                  <ul className="sub-menu">
                    {[
